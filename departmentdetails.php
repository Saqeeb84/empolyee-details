...
<body> <nav class="navbar navbar-expand-lg  bg-warning">
  ...
  <h1>GMR-TECHNOLOGY</h1>
    ...
    <form name="f1" action="departmentdetails.php" method="POST">
      <input type ="text" name="t1" placeholder="Enter Department code">
...
$result=mysqli_query($con,"SELECT * FROM department WHERE dcode='$dc'");
echo"<center>";
...
<h3><a href="http://localserver/emp/department.html">Back</a></h3> 